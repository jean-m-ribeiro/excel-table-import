...
If MultipleSelection = True Then
    MultipleSelectionSameSettings = IsMultipleSelectionSameSettings()
End If
...
If MultipleSelectionSameSettings = False Then
...
OtherTableColumns, MultipleSelection, MultipleSelectionSameSettings)
...
Function IsMultipleSelection() As Boolean
    Answer = MsgBox("Os dados serão importados de mais de um arquivo?", vbYesNo + vbInformation)
...
ByVal IsMultipleSelection As Boolean, ByVal MultipleSelectionSameSettings As Boolean)
    If IsMultipleSelection = True Then
        ...
        OtherFirstCell, OtherTableColumns, MultipleSelectionSameSettings)
    Else
...
ByVal OtherPath As String, ByVal OtherWorksheetName As String, ByVal OtherFirstCell As String, ByVal OtherTableColumns As Variant, _
ByVal MultipleSelectionSameSettings As Boolean)
    OtherWorkbookPath = Dir(OtherPath & "\" & "*.xls*")
    Do
        Workbooks.Open OtherPath & "\" & OtherWorkbookPath
